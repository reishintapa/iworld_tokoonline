...
<html>
<head>
	<title>iWorld Online Store</title>
...
<body>
	<div class="container-fluid">
		<div class="row top">
			<center>
				<div class="col-md-4" style="padding: 3px; background-color: #272829;">
					<span> <i class="glyphicon glyphicon-earphone"></i> +6285155299751</span>
				</div>


				<div class="col-md-4"  style="padding: 3px; background-color: #272829;">
					<span><i class="glyphicon glyphicon-envelope"></i> rei@iworld.com</span>
				</div>


				<div class="col-md-4"  style="padding: 3px; background-color: #272829;">
					<span>iWorld Online Store</span>
				</div>
			</center>
		</div>
	</div>
	...
	<nav class="navbar navbar-default" style="padding: 5px;">
		<div class="container">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#" style="color: #272829"><b>Selamat datang di toko online kami!</b></a>
			</div>
